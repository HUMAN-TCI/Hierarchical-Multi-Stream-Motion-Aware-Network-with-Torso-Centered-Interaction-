...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE HYDRA_FULL_ERROR=1 \
conda run --no-capture-output -n t2m \
python inference.py ${EXP_ROOT}/${EXP_NAME} --best_on_metric ${BEST_METRIC} --set test
